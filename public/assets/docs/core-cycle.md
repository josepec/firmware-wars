...
1. Cada Programador lanza un mini-duelo de **Piedra-Papel-Tijera** (**PPT protocol**):<br>
   · Gana el Programador que vence la jugada.<br>
...
3. Al inicio de los siguientes turnos, se produce un **upgrade()** de todos los Bots:<br>
**Ronda 3** → Ejecución de `upgrade()` → Todos los Bots pasan a `version` 2.<br>
...
/img-center /assets/img/spider-robot.png print-only h:150px
